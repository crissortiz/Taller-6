...
public class VentanaMapa extends JFrame implements ActionListener
{
    ...
    public VentanaMapa( VentanaPrincipal ventanaPrincipal, List<Restaurante> restaurantes )
    {
        ...
        panelMapa.actualizarMapa(restaurantes); // Actualiza el mapa con todos los restaurantes al inicio
        ...
        radioTodos.setSelected(true); // Por defecto, muestra todos los restaurantes
